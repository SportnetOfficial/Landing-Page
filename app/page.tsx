  ...
  const features = [
    {
      ...
      feature: 'Crowdfunding for atheletes',
    ...
    },
    {
      ...
      summary: 'Put your brand out there to increse the reach and engagement',
    },
    {
      image: '/assets/icons/features/touch.svg',
      feature: 'NFT Rewards',
      summary: 'Put your app in-front of the right users to drive downloads and engagement',
    },
  ]
  return (
    <>
      <SectionContainer>
        <Container>
          ...
          <div className="my-20 w-full flex justify-between lg:px-14 px-3 pt-10">
            <div className="">
              <h1 className=" text-6xl py-3 font-bold">
                SportNet 
              </h1>
              <div className=" text-4xl py-3">
                An Athlete Crowdfunding<br />
            ...
            <div className="flex-col items-center justify-center gap-4 md:flex hidden">
              <Image
                ...
                height={300}
              />
              <Image src="/assets/images/underline1.svg" alt="underline" width={480} height={36} />
            </div>
          </div>
          </Reveal>
        </Container>
      ...
      <SectionContainer className="bg-secondary">
        <Container>
          ...
          <div className="w-full mt-10" id="aboutus">
            ...
            To bridge the gap between talent and opportunity for athletes  in <br /> underdeveloped and developing countries, 
             enabling them <br /> to achieve their dreams and gain global recognition
            </p>
          </div>
